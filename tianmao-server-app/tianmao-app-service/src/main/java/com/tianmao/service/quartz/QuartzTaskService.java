...
import cn.alphaidea.wancheleyuan.common.dto.mall.QuartzTaskDtoFilter;
import cn.alphaidea.wancheleyuan.common.model.quartzs.QuartzTask;
import cn.alphaidea.wancheleyuan.common.type.quartz.TaskStatus;
...
/**
    ...
    boolean updateStopJob(@RequestParam("orderId") Long orderId);
