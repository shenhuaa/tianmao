...
public final class FileUploadUtil {
     ...
     * @return
     */
    public static String getSaveStoragePath(String storagePath, String extension) {
     ...
     * @return
     */
    public static boolean generateImage(String base64, String storagePath) {
    ...
    public static void main(String[] args) {
        ...
        Request request = new Request.Builder().url("http://127.0.0.1:8090/com.tianmao.common/uploadImg")
