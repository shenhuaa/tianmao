        ...
        Paging = {
            ...
            "setOptions": function(opts) {
                ...
                Paging.opts = $.extend(Paging.opts || {
                    ...
                    "perpage"           : 10,	// number of elements per pagingAttribute
                    "page"              : 1,	// current pagingAttribute
                    "refresh"		: {
                        "interval": 10,
                        "url": null
                    ...
                    switch (type) {
                            ...
                            case 'block':
                                    ...
                                    else if (this.value != this.pagingAttribute)
                    ...
                    **/
                    ...
                    "onSelect"		: function (page){	// callback for pagingAttribute selection
                        ...
                        **/
                        ...
                        /** EXAMPLE AJAX **
                            ...
                            $.ajax({
                                    "url": '/data.php?start=' + this.slice[0] + '&end=' + this.slice[1] + '&pagingAttribute=' + pagingAttribute,
                ...
                // If the number of elements per pagingAttribute is less then 1, set it to default
		...
		if (Paging.opts["lock"]) {
		    ...
		    return Paging;
                ...
                if (number < 0) {
                     ...
                     * - p: Elements per pagingAttribute
                     * - o: Offset (lapping)
                     ...
                     * Condition: o < p
                     *
                     * Page             Last element of pagingAttribute
                     * =====================================
                     * 1                p
                     * 2                2p - o
                     * 3                3p - 2o
                     ...
                     * k + 1            (k + 1)p - ko
                     *
                     *  => kp - (k - 1)o < n <= (k + 1)p - ko       (n is on pagingAttribute k+1)
                     * <=> k(p - o) + o < n <= k(p - o) + p
                     * <=> (n - p) / (p - o) <= k < (n - o) / (p - o)
                     *  => k = ceil((n - p) / (p - o))
                     *
                    ...
                    // If current pagingAttribute is negative, start at the end and
                    // Set the current pagingAttribute into a valid range, includes 0, which is set to 1
                ...
                data = {
                    ...
                    "perpage"	: opts["perpage"], // number of elements per pagingAttribute
                    "page"	: page,		// current pagingAttribute
                    "slice"	: [		// two element array with bounds of the current pagingAttribute selection
                ...
                function buffer_append(opts, data, type) {
                    ...
                    if (data["value"])
                        buffer+= type.replace(/<a/i, '<a data-pagingAttribute="' + data["value"] + '"');
                    else
                        buffer+= type;
                }
                    ...
                    switch (node.ftype) {
                        case "block":
                            for (; rStart < rStop; ++rStart) {
                                ...
                                data["first"]      = 1 === rStart;                      // check if it is the first pagingAttribute
