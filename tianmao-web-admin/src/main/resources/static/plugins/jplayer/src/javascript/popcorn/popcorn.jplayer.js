				...
				(function($) {
					...
					myPlayer.bind($.jPlayer.event.error, function(event) {
						...
						if(error.type === $.jPlayer.error.URL) {
							error.code = 4; // MEDIA_ERR_SRC_NOT_SUPPORTED since jPlayer makes this assumption. It is the most com.tianmao.common error, then the decode error. Never seen either of the other 2 error types occur.
						} else {
