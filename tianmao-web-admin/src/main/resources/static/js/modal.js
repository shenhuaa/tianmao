...
+function ($) {
  ...
  $(function(){
    ...
    $(document).on('click', '[data-toggle="ajaxModal"]',
      function(e) {
        ...
        $modal.load($remote,param,function(){ 
 ...
 // ajax modal
    $(document).on('click', '[data-toggle="ajaxModal1"]',
      function(e) {
    	var param = $("#modalForm1").serialize();
    	param = decodeURIComponent(param,true);
    	$('#ajaxModal').remove();
        $('#ajaxModal1').remove();
        $(".modal-backdrop").remove();
        ...
        var $this = $(this)
          , $remote = $this.data('remote') || $this.attr('href')
          , $modal = $('<div class="modal" id="ajaxModal1"><div class="modal-body"></div></div>');
        $('body').append($modal);
        $modal.modal({backdrop: 'static', keyboard: false});
        $modal.load($remote,param);
      }
    );
 ...
 // ajax moda2
    $(document).on('click', '[data-toggle="ajaxModal2"]',
      function(e) {
        ...
        var $this = $(this)
          , $remote = $this.data('remote') || $this.attr('href')
          , $modal = $('<div class="modal" id="ajaxModal2"><div class="modal-body"></div></div>');
        $('body').append($modal);
        $modal.modal({backdrop: 'static', keyboard: false});
        $modal.load($remote,param);
      }
