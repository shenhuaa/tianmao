...
function(t, e, n, i) {
	...
	t.modal = function(n, i) {
		...
		var c = t.modal({//这里有修改,之前的input的type值是text
			text: '<p class="weui-prompt-text">' + (s.text || "") + '</p><input type="password" class="weui-input weui-prompt-input" id="weui-prompt-input" placeholder="' + (s.input || "") + '" />',
			title: s.title,
			autoClose: !1,
			buttons: [{
				text: e.buttonCancel,
...
function(t) {
	...
	var e = function(e) {
		...
		var c = this,
			l = {
				...
				toolbarCloseText: "完成",
				title: "请选择",
				toolbarTemplate: '<div class="toolbar">          <div class="toolbar-inner">    <a href="javascript:;" class="picker-button-close close-picker">取消</a>      <a href="javascript:;" class="picker-button close-picker">{{closeText}}</a>          <h1 class="ntitle">{{title}}</h1>          </div>          </div>'
				//<a href="javascript:;" class="picker-button-close close-picker">取消</a>
				//添加取消按钮
			};
		e = e || {};
	...
	//关闭遮罩层
	t(document).on("click", ".selclip", function() {
		$(".selclip").remove();
	});
	//关闭遮罩层
	t(document).on("click", ".close-picker", function() {
		...
		//添加遮罩层
		var selclip = t("<div class='selclip'></div>").appendTo(document.body);
		//添加遮罩层
		...
		return this.each(function() {
			if(this) {
				...
				if(!r) {
					...
					/*t(document).on("click", ".picker-button-close", function() {
						r.val("");
					});*/
	...
	n.prototype.initConfig = function() {
		...
		if(!this._open) {
			this.parseInitValue();
			var i = this.config,
				a = this.dialog = t.openPicker(this.getHTML());
		...
		min: void 0,
		max: void 0,
		toolbarTemplate: '<div class="toolbar"> <div class="toolbar-inner">        <div class="toolbar-inner">      <a href="javascript:;" class="picker-button close-select">{{closeText}}</a>      <h1 class="title">{{title}}</h1>      </div>      </div>',
